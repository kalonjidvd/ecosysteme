 ...
 * Last modified on Apr 21 13:25 2017
 */
...
/**
 Type concret Lion derive de Faune
 */
class Lion : public Faune
{
public:
    /**
     Constructeur.
     ...
     attributs herites. Ensuite cree une instance du type concret Carnivore derive
     du type abstrait RegimeAlimentaire a laquelle est delegue le comportement
     ...
     @param espece
     */
    Lion(string espece, int energie);

    /**
     Destructeur

     Les classes polymorphique tel Lion (derivees d'un type de base qui a au
