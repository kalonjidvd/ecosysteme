...
/**
 * Classe concrete Babouin sous-classe de Faune.
 */
public class Babouin extends Faune{

    /**
     * Constructeur
     * Il fait appel au constructeur de la superclasse Faune pour initialiser les
     * attributs herites. Ensuite cree une instance de la classe concrete Herbivore
     ...
     * @param energie
     */
    public Babouin(String espece, int energie){
