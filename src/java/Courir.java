...
/**
 * Classe concrete Courir implementant l'interface Mobilite.
 */
public class Courir implements Mobilite{
    /**
     ...
     * dans la classe abstraite Faune, sert a afficher le type dynamique de
    ...
    public void seMouvoir(Faune laFaune){
         ...
         */
        System.out.println(laFaune + " : je cours...");
    }
}
